...
@keyframes blinker1 {  
 ...
 100% { opacity: 1.0; }
  ...
  <span class="timeel timeRefSeconds">sec</span>
                ...
                <a href="https://recordinfo.typeform.com/to/zqHYWv"> Request Food </a> 
                     <p >Support by supplying food materials for needy </p>
                    <a href="https://recordinfo.typeform.com/to/wCeykF">Contribute Food</a>
                      <p  >Enter location details while distributing food</p>
                    <a href="{{ route('distributer') }}">Volunteer Login</a>
                      <p >Enter Food Distribution Details by NGO</p>
                     <a href="{{ route('ngo-login') }}">NGO Login</a>
